...
// line:
//
//  % ./gencordic -vca -f ../rtl/cordic.v -v -i 16 -o 16 -p 32 -t p2r -x 2 -c
//
...
module	cordic#(
	...
	//
	wire	[31:0]	cordic_angle [0:(NSTAGES-1)];

	assign	cordic_angle[ 0] = 32'h12e4_051d; //  26.565051 deg
	assign	cordic_angle[ 1] = 32'h09fb_385b; //  14.036243 deg
	assign	cordic_angle[ 2] = 32'h0511_11d4; //   7.125016 deg
	assign	cordic_angle[ 3] = 32'h028b_0d43; //   3.576334 deg
	assign	cordic_angle[ 4] = 32'h0145_d7e1; //   1.789911 deg
	assign	cordic_angle[ 5] = 32'h00a2_f61e; //   0.895174 deg
	assign	cordic_angle[ 6] = 32'h0051_7c55; //   0.447614 deg
	assign	cordic_angle[ 7] = 32'h0028_be53; //   0.223811 deg
	assign	cordic_angle[ 8] = 32'h0014_5f2e; //   0.111906 deg
	assign	cordic_angle[ 9] = 32'h000a_2f98; //   0.055953 deg
	assign	cordic_angle[10] = 32'h0005_17cc; //   0.027976 deg
	assign	cordic_angle[11] = 32'h0002_8be6; //   0.013988 deg
	assign	cordic_angle[12] = 32'h0001_45f3; //   0.006994 deg
	assign	cordic_angle[13] = 32'h0000_a2f9; //   0.003497 deg
	assign	cordic_angle[14] = 32'h0000_517c; //   0.001749 deg
	assign	cordic_angle[15] = 32'h0000_28be; //   0.000874 deg
	assign	cordic_angle[16] = 32'h0000_145f; //   0.000437 deg
	assign	cordic_angle[17] = 32'h0000_0a2f; //   0.000219 deg
	assign	cordic_angle[18] = 32'h0000_0517; //   0.000109 deg
	// {{{
	// Std-Dev    : 0.00 (Units)
