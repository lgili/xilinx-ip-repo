...
ipx::add_port_map i_sys_clk [ipx::get_bus_interfaces clk -of_objects ${ip_core}]
set_property physical_name s00_axi_aclk [ipx::get_port_maps i_sys_clk -of_objects [ipx::get_bus_interfaces clk -of_objects ${ip_core}]]
