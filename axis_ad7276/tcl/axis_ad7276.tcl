...
set_property value axis_o:s_axi:axis_ad1:axis_ad2:axis_ad3:axis_adc [ipx::get_bus_parameters ASSOCIATED_BUSIF -of_objects [ipx::get_bus_interfaces clk -of_objects ${ip_core}]]
