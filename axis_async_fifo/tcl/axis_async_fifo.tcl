...
set aclk_intf [ipx::get_bus_interfaces m_clk -of_objects ${ip_core}]
...
set_property value m_rst $aclk_assoc_reset

set aclk_intf [ipx::get_bus_interfaces s_clk -of_objects ${ip_core}]
set aclk_assoc_intf [ipx::add_bus_parameter ASSOCIATED_BUSIF $aclk_intf]
set_property value s_axis $aclk_assoc_intf
set aclk_assoc_reset [ipx::add_bus_parameter ASSOCIATED_RESET $aclk_intf]
set_property value s_rst $aclk_assoc_reset


# Set reset polarity
set aresetn_intf [ipx::get_bus_interfaces m_rst -of_objects ${ip_core}]
set aresetn_polarity [ipx::add_bus_parameter POLARITY $aresetn_intf]
set_property value ACTIVE_LOW ${aresetn_polarity}

set aresetn_intf [ipx::get_bus_interfaces s_rst -of_objects ${ip_core}]
set aresetn_polarity [ipx::add_bus_parameter POLARITY $aresetn_intf]
set_property value ACTIVE_LOW ${aresetn_polarity}
